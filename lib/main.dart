...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  void initState() {
    super.initState();
    debugPrint('INIT STATE MESSAGES');
  }

  @override
  void dispose() {
    debugPrint('DISPOSE MESSAGES');
    super.dispose();
  }
...
class HomeDetailScreen extends StatefulWidget with RouteWidgetMixin {
  @override
  final RouteState? routeState;
...
class _HomeDetailScreenState extends State<HomeDetailScreen> {
  ...
  @override
  void dispose() {
    debugPrint('DISPOSE HOME DETAIL');
    super.dispose();
  }
